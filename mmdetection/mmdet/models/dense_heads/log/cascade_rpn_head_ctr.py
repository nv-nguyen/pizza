...
class StageCascadeRPNHead(RPNHead):
    ...
    def forward_single(self, x, offset):
        ...
        return bridged_x, cls_score, centerness, bbox_pred
    ...
    def loss_atss_single(self, anchors, cls_score, bbox_pred, centerness, labels,
        ...
        if len(pos_inds) > 0:
            ...
            if not self.use_iou:
                ...
                loss_bbox = self.loss_bbox(
                    pos_decode_bbox_pred,
                    pos_decode_bbox_targets,
                    weight=centerness_targets.clamp(min=1e-6),
                    avg_factor=1.0)
    ...
    def loss(self,
        ...
        losses_cls, losses_bbox, losses_centerness,\
        ...
        return dict(loss_rpn_reg=losses_bbox, loss_rpn_centerness=losses_centerness)
    ...
    def get_bboxes(self,
        ...
        for img_id in range(len(img_metas)):
            ...
            proposals = self._get_bboxes_single(cls_score_list, bbox_pred_list, centerness_list,
    ...
    def _get_bboxes_single(self,
        ...
        for idx in range(len(cls_scores)):
            ...
            if self.use_sigmoid_cls:
                ...
                #scores = rpn_centerness.sigmoid()
                scores = rpn_cls_score.sigmoid() * rpn_centerness.sigmoid()
            else:
    ...
    def forward_train(self,
        ...
        for i in range(self.num_stages):
            ...
            if stage.adapt_cfg['type'] == 'offset':
                ...
                offset_list = None
            x, cls_score, centerness, bbox_pred = stage(x, offset_list)
            rpn_loss_inputs = (anchor_list, valid_flag_list, cls_score, centerness,
        ...
        if proposal_cfg is None:
            ...
            proposal_list = self.stages[-1].get_bboxes(anchor_list, cls_score, bbox_pred, centerness,
                                                       img_metas,
                                                       self.test_cfg)
