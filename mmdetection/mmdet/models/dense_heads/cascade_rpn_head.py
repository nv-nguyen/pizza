...
class CascadeRPNHead(BaseDenseHead):
    ...
    def aug_test_rpn(self, feats, img_metas):
        ...
        for aug_idx, (x, img_meta) in enumerate(zip(feats, img_metas)):
            ...
            aug_proposals.append(proposals_new)
        '''
    ...
    def aug_test_rpn_old(self, feats, img_metas, rescale=False):
        ...
        merged_proposals = self.merge_aug_vote_results(aug_proposals, img_metas)

        det_bboxes = []

        scores_j = merged_proposals[:, 4]
        bboxes_j = merged_proposals[:, :4].view(-1, 4)
        ...
        if len(det_bboxes) > 0:
            ...
            det_bboxes = merged_proposals.new_zeros((0, 5))
