...
def render_blender_proc(cad_path, output_dir, obj_poses, img_size=None,
                        scale_meter=True, intrinsic=None, recenter_origin=False):
    bproc.init()
...
if __name__ == '__main__':
    ...
    obj_poses = np.load(args.obj_pose)
    ...
    render_blender_proc(args.cad_path, args.output_dir, obj_poses, intrinsic=intrinsic, img_size=img_size,
                        scale_meter=True, recenter_origin=True)
    if args.disable_output == "true":
